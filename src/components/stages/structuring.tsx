          ...
          <>
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-2">
                <p className="text-xl font-bold">Stage: STRUCTURING</p>
                <Badge
                  variant="secondary"
            ...
            <div className="flex items-center space-x-2 text-muted-foreground">
              ...
              <p className="text-sm">Next Stage: SUMMARY - 30 minutes</p>
              <div className="h-6 w-px bg-border"></div>
      ...
      <div className="flex space-x-6">
        ...
        <div className="flex flex-col flex-grow border border-border rounded-lg p-4 bg-background/50 backdrop-blur-sm">
          <Accordion
            type="single"
            collapsible
            defaultValue={simulation?.data.isViewedGuidance ? "" : "item-1"}
